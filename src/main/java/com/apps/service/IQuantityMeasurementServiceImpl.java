...
public class IQuantityMeasurementServiceImpl implements IQuantityMeasurementService {

    private final IQuantityMeasurementRepository repository;

    public IQuantityMeasurementServiceImpl(IQuantityMeasurementRepository repository) {
    ...
    public double divide(QuantityDTO q1, QuantityDTO q2) {
        ...
        repository.saveMeasurement(
                new QuantityMeasurementEntity("DIVIDE",
                        quantity1.toString(),
                        quantity2.toString(),
