...
public class AuthControllerTest {
	    ...
	    void testRegisterUser() throws Exception {
	        ...
	        User userEntity = new User(1L, "Suhani", "suhani@gmail.com", null, "encoded_pass", "ROLE_USER", "LOCAL");
	        ...
	        mockMvc.perform(post("/auth/register")
	                ...
	                .andExpect(jsonPath("$.email").value("suhani@gmail.com"));
	    }

	    @Test
	    void testLoginUser() throws Exception {
	        User user = new User(null, "Suhani", "suhani@gmail.com", null, "1234", "USER", null);
