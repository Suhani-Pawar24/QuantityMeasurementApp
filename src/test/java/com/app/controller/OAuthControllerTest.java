...
public class OAuthControllerTest {
	    ...
	    void testOAuthSuccess_ExistingUser() throws Exception {
	        ...
	        existingUser.setEmail("suhani@gmail.com");
	        existingUser.setName("Suhani");

	        // 2. Mock behavior
	        when(userRepository.findByEmail("suhani@gmail.com")).thenReturn(Optional.of(existingUser));
	        ...
	        mockMvc.perform(get("/oauth/success")
	                .with(oauth2Login() // Simulates the @AuthenticationPrincipal
	                    .attributes(attrs -> {
	                        attrs.put("email", "suhani@gmail.com");
	                        attrs.put("name", "Suhani");
	                    })))
