...
export function MeasurementProvider({ children }) {
  ...
  const actions = {
    setType: useCallback((type) => dispatch({ type: 'SET_TYPE', payload: type }), []),
    setAction: useCallback((action) => dispatch({ type: 'SET_ACTION', payload: action }), []),
    setUnits: useCallback((units) => dispatch({ type: 'SET_UNITS', payload: units }), []),
    setFromUnit: useCallback((unit) => dispatch({ type: 'SET_FROM_UNIT', payload: unit }), []),
    setToUnit: useCallback((unit) => dispatch({ type: 'SET_TO_UNIT', payload: unit }), []),
    setFromValue: useCallback((value) => dispatch({ type: 'SET_FROM_VALUE', payload: value }), []),
    setToValue: useCallback((value) => dispatch({ type: 'SET_TO_VALUE', payload: value }), []),
    setOperator: useCallback((operator) => dispatch({ type: 'SET_OPERATOR', payload: operator }), []),
    setResult: useCallback((result) => dispatch({ type: 'SET_RESULT', payload: result }), []),
